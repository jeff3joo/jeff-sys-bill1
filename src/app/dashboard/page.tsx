...
import { markAppointmentComplete } from "@/app/schedule/actions";
...
export default function DashboardPage() {
	...
	const handleCompleteAppointment = async (e: React.MouseEvent, id: string) => {
		e.preventDefault();
		e.stopPropagation();
										...
										>
											...
											>
												...
												>
													...
													<Button
														size='small'
														disabled={completingIds.has(appt.id)}
														onClick={(e) => handleCompleteAppointment(e, appt.id)}
														startIcon={
															completingIds.has(appt.id) ? (
																<CircularProgress size={13} sx={{ color: "#059669" }} />
															) : (
																<CheckCircleOutlined sx={{ fontSize: { xs: "16px !important", sm: "14px !important" } }} />
															)
														}
														sx={{
													...
													>
														{completingIds.has(appt.id) ? "..." : "Complete"}
													</Button>
												</Stack>
											</Box>
										</Card>
